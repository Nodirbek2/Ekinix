...
export const translations: Record<Language, Translations> = {
  ...
  ru: {
    ...
    howItWorksSubtitle: "3 простых шага для современного управления фермой с Ekinix",
    step1Title: "1. Отметьте границы поля",
    step1Desc: "Легко нарисуйте границы вашего участка на интерактивной карте.",
    step2Title: "2. Спутниковый анализ и полив",
    step2Desc: "Получайте индекс вегетации NDVI и автоматический график полива.",
    step3Title: "3. Продавайте урожай напрямую",
    step3Desc: "Размещайте продукцию на рынке без посредников и комиссий.",

    demoTitle: "Попробуйте платформу Ekinix",
    demoSubtitle: "Простые и понятные инструменты для каждого дехканина",
    tabSatellite: "Спутниковый мониторинг",
    tabWeather: "Погода и полив",
    tabMarket: "Рынок урожая",
    tabGuides: "Агро-справочник",

    satelliteHeader: "Карта NDVI и влажности поля",
    selectField: "Выберите поле",
    ndviIndex: "Индекс вегетации NDVI",
    soilMoisture: "Оценочный индекс влажности (Модель + NDVI)",
    fieldStatus: "Состояние посевов",
    fieldStatusGood: "Здоровое развитие",
    fieldStatusWarning: "Дефицит влаги",
    irrigationAdvice: "Рекомендация по поливу",
    satelliteNote: "Спутниковые снимки обновляются каждые 3-5 дней через Sentinel Hub и Open-Meteo.",

    weatherHeader: "Агрометеорология и график полива по регионам Узбекистана",
    ...
    marketHeader: "Сельскохозяйственный рынок урожая",
    marketSub: "Прямая площадка для дехкан и покупателей. Все цены в сумах.",
    addListing: "+ Разместить объявление",
    filterAll: "Все культуры",
    pricePerUnit: "Цена (за 1 кг/т)",
    quantity: "Объем",
    contactFarmer: "Связаться с фермером",
    location: "Локация",

    guidesHeader: "Полезные справочники для фермеров",
    guidesSub: "Советы экспертов по уходу за хлопком, пшеницей, садами и овощными культурами",
    readMore: "Подробнее",
    ...
    supabaseConnected: "Подключено к базе данных Supabase (Активно)",
    supabaseNotConnected: "Ключи Supabase не настроены (Демо-режим)",
    noAccount: "Нет аккаунта? Зарегистрироваться",
    hasAccount: "Уже есть аккаунт? Войти",

    onboardingTitle: "Настройка профиля фермера",
    onboardingSubtitle: "3 быстрых шага для получения персонализированных рекомендаций",
    stepCounter: "Шаг",
    onboardingStep1Title: "Имя фермера и регион",
    onboardingStep1Sub: "Укажите ваше имя и расположение земельного участка",
    onboardingStep2Title: "Тип хозяйства",
    onboardingStep2Sub: "Выберите масштаб вашего агробизнеса",
    onboardingStep3Title: "Основные культуры",
    onboardingStep3Sub: "Выберите основные выращиваемые культуры (можно несколько)",
    farmTypeSmallholderTitle: "Дехканское / Небольшое хозяйство",
    farmTypeSmallholderDesc: "Для семейного потребления и местных рынков (0.1–10 га)",
    farmTypeCommercialTitle: "Крупное / Коммерческое хозяйство",
    farmTypeCommercialDesc: "Для промышленного масштаба и экспорта (10+ га)",
    cropCotton: "Хлопок",
    cropWheat: "Пшеница",
    ...
    btnNext: "Далее →",
    btnBack: "← Назад",
    btnFinish: "Сохранить и завершить",
    myProfile: "Мой профиль",
    logout: "Выйти",

    myFieldsTitle: "Мои поля",
    myFieldsSubtitle: "Отметьте границы на карте для мониторинга влажности и вегетации",
    addFieldBtn: "+ Добавить поле",
    fieldNameLabel: "Название поля",
    cropTypeLabel: "Культура",
    plantingDateLabel: "Дата посева",
    drawBoundaryInstruction: "Нажимайте на карту, чтобы поставить угловые точки (минимум 4 точки).",
    closeBoundaryBtn: "Завершить контур (замкнуть полигон)",
    boundaryClosed: "Граница успешно замкнута! Заполните данные ниже для сохранения.",
    reopenBoundary: "Изменить границы (редактировать)",
    calculatedArea: "Расчётная площадь",
    resetMapPoints: "Сбросить точки",
    saveFieldBtn: "Сохранить поле",
    noFieldsYet: "Пока нет добавленных полей",
    noFieldsSub: "Обозначьте границы на карте, чтобы получить доступ к спутниковой телеметрии",
    hectaresUnit: "гектаров",
    pointsCount: "точек контура",

    dashboardTitle: "Панель управления фермера",
    dashboardSubtitle: "Текущее состояние культур, погода Open-Meteo и рекомендации по поливу для каждого поля",
    healthStatusLabel: "Состояние культур",
    statusGood: "Хорошее (Здоровое)",
    statusModerate: "Умеренное состояние",
    statusStressed: "Требуется внимание",
    statusHealthy: "Здоровое (Зеленый)",
